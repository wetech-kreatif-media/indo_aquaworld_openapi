...
------------- | ------------- | -------------
[**addEventNominationContestant**](EventsApi.md#addeventnominationcontestant) | **POST** /public/event/{eventId}/contestan-nomination/{nominasiId} | Add Event Nomination Contestant
...
[**getEventNominationsContestants**](EventsApi.md#geteventnominationscontestants) | **GET** /public/event/{eventId}/contestan-nomination/{nominasiId} | Get Event Nomination Contestants
...
try {
    ...
    print('Exception when calling EventsApi->addEventNominationContestant: $e\n');
}
```
...
try {
    ...
    print('Exception when calling EventsApi->getEventNominationsContestants: $e\n');
}
```
