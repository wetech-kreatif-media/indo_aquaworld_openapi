...
part of 'request_contestant_data_content_inner.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RequestContestantDataContentInner
    extends RequestContestantDataContentInner {
  @override
  final String? id;
  @override
  ...
  factory _$RequestContestantDataContentInner(
          [void Function(RequestContestantDataContentInnerBuilder)? updates]) =>
      (new RequestContestantDataContentInnerBuilder()..update(updates))
          ._build();

  _$RequestContestantDataContentInner._(
      {this.id,
      this.createdBy,
      this.updatedBy,
      this.created,
  ...
  @override
  RequestContestantDataContentInner rebuild(
          void Function(RequestContestantDataContentInnerBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RequestContestantDataContentInnerBuilder toBuilder() =>
      new RequestContestantDataContentInnerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RequestContestantDataContentInner &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RequestContestantDataContentInner')
          ..add('id', id)
...
class RequestContestantDataContentInnerBuilder
    implements
        Builder<RequestContestantDataContentInner,
            RequestContestantDataContentInnerBuilder> {
  _$RequestContestantDataContentInner? _$v;
  ...
  RequestContestantDataContentInnerBuilder() {
    RequestContestantDataContentInner._defaults(this);
  }

  RequestContestantDataContentInnerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(RequestContestantDataContentInner other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RequestContestantDataContentInner;
  }
  ...
  @override
  RequestContestantDataContentInner build() => _build();

  _$RequestContestantDataContentInner _build() {
    final _$result = _$v ??
        new _$RequestContestantDataContentInner._(
            id: id,
            createdBy: createdBy,
            updatedBy: updatedBy,
            created: created,
