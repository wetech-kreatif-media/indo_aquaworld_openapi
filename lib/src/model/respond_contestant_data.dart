...
part 'respond_contestant_data.g.dart';
...
/// * [codeContestant] 
@BuiltValue()
abstract class RespondContestantData implements Built<RespondContestantData, RespondContestantDataBuilder> {
  ...
  RespondTeamData? get contestantTeam;

  @BuiltValueField(wireName: r'codeContestant')
  String? get codeContestant;

  RespondContestantData._();

  factory RespondContestantData([void updates(RespondContestantDataBuilder b)]) = _$RespondContestantData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RespondContestantDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RespondContestantData> get serializer => _$RespondContestantDataSerializer();
}

class _$RespondContestantDataSerializer implements PrimitiveSerializer<RespondContestantData> {
  @override
  final Iterable<Type> types = const [RespondContestantData, _$RespondContestantData];

  @override
  final String wireName = r'RespondContestantData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RespondContestantData object, {
  ...
  void _deserializeProperties(
    ...
    required RespondContestantDataBuilder result,
  ...
  @override
  RespondContestantData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RespondContestantDataBuilder();
