...
part of 'respond_tanks_data_content_inner_contestant.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RespondTanksDataContentInnerContestant
    extends RespondTanksDataContentInnerContestant {
  @override
  final String? id;
  @override
  ...
  factory _$RespondTanksDataContentInnerContestant(
          [void Function(RespondTanksDataContentInnerContestantBuilder)?
              updates]) =>
      (new RespondTanksDataContentInnerContestantBuilder()..update(updates))
          ._build();

  _$RespondTanksDataContentInnerContestant._(
      {this.id,
      this.createdBy,
      this.updatedBy,
      this.created,
  ...
  @override
  RespondTanksDataContentInnerContestant rebuild(
          void Function(RespondTanksDataContentInnerContestantBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RespondTanksDataContentInnerContestantBuilder toBuilder() =>
      new RespondTanksDataContentInnerContestantBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RespondTanksDataContentInnerContestant &&
        id == other.id &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'RespondTanksDataContentInnerContestant')
          ..add('id', id)
...
class RespondTanksDataContentInnerContestantBuilder
    implements
        Builder<RespondTanksDataContentInnerContestant,
            RespondTanksDataContentInnerContestantBuilder> {
  _$RespondTanksDataContentInnerContestant? _$v;
  ...
  RespondTanksDataContentInnerContestantBuilder() {
    RespondTanksDataContentInnerContestant._defaults(this);
  }

  RespondTanksDataContentInnerContestantBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(RespondTanksDataContentInnerContestant other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RespondTanksDataContentInnerContestant;
  }

  @override
  void update(
      void Function(RespondTanksDataContentInnerContestantBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RespondTanksDataContentInnerContestant build() => _build();

  _$RespondTanksDataContentInnerContestant _build() {
    final _$result = _$v ??
        new _$RespondTanksDataContentInnerContestant._(
            id: id,
            createdBy: createdBy,
            updatedBy: updatedBy,
            created: created,
