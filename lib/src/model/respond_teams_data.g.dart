...
part of 'respond_teams_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RespondTeamsData extends RespondTeamsData {
  @override
  final bool? last;
  @override
  final bool? first;
  ...
  factory _$RespondTeamsData(
      ...
      (new RespondTeamsDataBuilder()..update(updates))._build();

  _$RespondTeamsData._(
      {this.last,
      this.first,
      this.empty,
      this.size,
  ...
  @override
  RespondTeamsDataBuilder toBuilder() =>
      new RespondTeamsDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RespondTeamsData &&
        last == other.last &&
        first == other.first &&
        empty == other.empty &&
        size == other.size &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RespondTeamsData')
          ..add('last', last)
          ..add('first', first)
          ..add('empty', empty)
          ..add('size', size)
...
class RespondTeamsDataBuilder
    implements Builder<RespondTeamsData, RespondTeamsDataBuilder> {
  _$RespondTeamsData? _$v;
  ...
  ListBuilder<RespondTeamsDataContentInner>? _content;
  ListBuilder<RespondTeamsDataContentInner> get content =>
      _$this._content ??= new ListBuilder<RespondTeamsDataContentInner>();
  set content(ListBuilder<RespondTeamsDataContentInner>? content) =>
      _$this._content = content;

  RespondTeamsDataBuilder() {
    RespondTeamsData._defaults(this);
  }

  RespondTeamsDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _last = $v.last;
      _first = $v.first;
  ...
  @override
  void replace(RespondTeamsData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RespondTeamsData;
  }

  @override
  void update(void Function(RespondTeamsDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RespondTeamsData build() => _build();

  _$RespondTeamsData _build() {
    _$RespondTeamsData _$result;
    try {
      _$result = _$v ??
          new _$RespondTeamsData._(
              last: last,
              first: first,
              empty: empty,
              size: size,
