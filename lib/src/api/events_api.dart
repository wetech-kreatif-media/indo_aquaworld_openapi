...
class EventsApi {
  ...
  Future<Response<RespondGlobal>> addEventNominationContestant({ 
    required String eventId,
    required String nominasiId,
    RequestContestanNomination? requestContestanNomination,
    ...
    final _path = r'/public/event/{eventId}/contestan-nomination/{nominasiId}'.replaceAll('{' r'eventId' '}', eventId.toString()).replaceAll('{' r'nominasiId' '}', nominasiId.toString());
    ...
    try {
      const _type = FullType(RequestContestanNomination);
      _bodyData = requestContestanNomination == null ? null : _serializers.serialize(requestContestanNomination, specifiedType: _type);
  ...
  Future<Response<RespondEvent>> getEvent({ 
    ...
    RespondEvent? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondEvent),
      ) as RespondEvent;
  ...
  Future<Response<RespondEventNominations>> getEventNominations({ 
    ...
    RespondEventNominations? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondEventNominations),
    ...
    return Response<RespondEventNominations>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RespondContestanNominations] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondContestanNominations>> getEventNominationsContestants({ 
    required String eventId,
    required String nominasiId,
    RequestEvent? requestEvent,
    CancelToken? cancelToken,
    ...
    RespondContestanNominations? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondContestanNominations),
      ) as RespondContestanNominations;
    ...
    return Response<RespondContestanNominations>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondEvents>> getEvents({ 
    ...
    RespondEvents? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondEvents),
      ) as RespondEvents;
