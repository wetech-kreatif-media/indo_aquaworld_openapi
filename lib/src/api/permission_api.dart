...
class PermissionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RequestPermission] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RequestPermission>> createPermission({ 
    ...
    final _path = r'/public/permission';
    ...
    try {
      const _type = FullType(RequestPermission);
      _bodyData = requestPermission == null ? null : _serializers.serialize(requestPermission, specifiedType: _type);
    ...
    RequestPermission? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RequestPermission),
    ...
    return Response<RequestPermission>(
      data: _responseData,
  ...
  Future<Response<RespondPermissions>> getPermissions({ 
    ...
    final _path = r'/public/permissions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RespondPermissions? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondPermissions),
      ) as RespondPermissions;
    ...
    return Response<RespondPermissions>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
