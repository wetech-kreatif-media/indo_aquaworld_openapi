...
class ArticleApi {
  ...
  const ArticleApi(this._dio, this._serializers);
  ...
  Future<Response<RespondArticle>> getArticleDetail({ 
    ...
    RespondArticle? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondArticle),
      ) as RespondArticle;
    ...
    return Response<RespondArticle>(
      data: _responseData,
  ...
  Future<Response<RespondArticles>> getArticles({ 
    ...
    RespondArticles? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondArticles),
      ) as RespondArticles;
    ...
    return Response<RespondArticles>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondGlobal>> postArticle({ 
    ...
    try {
      const _type = FullType(RequestArticle);
