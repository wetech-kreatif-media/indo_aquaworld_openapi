...
class KompetisiApi {
  ...
  const KompetisiApi(this._dio, this._serializers);
  ...
  Future<Response<RespondKompetisiDetail>> addKompetisi({ 
    ...
    try {
      const _type = FullType(RequestKompetisiDetail);
      _bodyData = requestKompetisiDetail == null ? null : _serializers.serialize(requestKompetisiDetail, specifiedType: _type);
    ...
    RespondKompetisiDetail? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondKompetisiDetail),
      ) as RespondKompetisiDetail;
    ...
    return Response<RespondKompetisiDetail>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> delKompetisiIdJudge({ 
    required String komId,
    RequestJudgeKompetisi? requestJudgeKompetisi,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/kompetisi/{komId}/judge'.replaceAll('{' r'komId' '}', komId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestJudgeKompetisi);
      _bodyData = requestJudgeKompetisi == null ? null : _serializers.serialize(requestJudgeKompetisi, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> deleteKompetisiNominationsIdParticipant({ 
    required String komId,
    required String nomId,
    RequestKompetisiNominasiPartisipant? requestKompetisiNominasiPartisipant,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/kompetisi/{komId}/nomination/{nomId}'.replaceAll('{' r'komId' '}', komId.toString()).replaceAll('{' r'nomId' '}', nomId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestKompetisiNominasiPartisipant);
      _bodyData = requestKompetisiNominasiPartisipant == null ? null : _serializers.serialize(requestKompetisiNominasiPartisipant, specifiedType: _type);
  ...
  Future<Response<RespondKompetisiList>> getKompetisi({ 
    ...
    RespondKompetisiList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondKompetisiList),
      ) as RespondKompetisiList;
    ...
    return Response<RespondKompetisiList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RespondJudgeNominasi] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondJudgeNominasi>> getKompetisiIdJudgement({ 
    required String komId,
    required String nomId,
    ...
    final _path = r'/kompetisi/{komId}/nomination/{nomId}/judgement/{judgeId}'.replaceAll('{' r'komId' '}', komId.toString()).replaceAll('{' r'nomId' '}', nomId.toString()).replaceAll('{' r'judgeId' '}', judgeId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RespondJudgeNominasi? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondJudgeNominasi),
      ) as RespondJudgeNominasi;
    ...
    return Response<RespondJudgeNominasi>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RespondUsersJudge] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondUsersJudge>> getKompetisiIdJudges({ 
    required String komId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    RespondUsersJudge? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondUsersJudge),
      ) as RespondUsersJudge;
    ...
    return Response<RespondUsersJudge>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondKompetisiNominationList>> getKompetisiIdNomination({ 
    required String komId,
    String? nominasiCari,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/kompetisi/{komId}/nomination'.replaceAll('{' r'komId' '}', komId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RespondKompetisiParticipants>> getKompetisiIdParticipants({ 
    ...
    RespondKompetisiParticipants? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondKompetisiParticipants),
      ) as RespondKompetisiParticipants;
  ...
  Future<Response<RespondKompetisiNominationDetail>> getKompetisiNominationId({ 
    ...
    final _path = r'/kompetisi/{komId}/nomination/{participant_id}/result'.replaceAll('{' r'komId' '}', komId.toString()).replaceAll('{' r'participant_id' '}', participantId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondKompetisiParticipants] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondKompetisiParticipants>> getKompetisiNominationsId({ 
    required String komId,
    required String nomId,
    String? nominasiCari,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondKompetisiParticipants] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondKompetisiParticipants>> getKompetisiNominationsIdSummary({ 
    required String komId,
    required String nomId,
    String? nominasiCari,
    CancelToken? cancelToken,
    ...
    final _path = r'/kompetisi/{komId}/nomination/{nomId}/summary'.replaceAll('{' r'komId' '}', komId.toString()).replaceAll('{' r'nomId' '}', nomId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> postKompetisiIdJudge({ 
    required String komId,
    RequestJudgeKompetisi? requestJudgeKompetisi,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> postKompetisiIdJudgement({ 
    required String komId,
    required String nomId,
    RequestJudgeNominasi? requestJudgeNominasi,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/kompetisi/{komId}/nomination/{nomId}/judgement'.replaceAll('{' r'komId' '}', komId.toString()).replaceAll('{' r'nomId' '}', nomId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestJudgeNominasi);
      _bodyData = requestJudgeNominasi == null ? null : _serializers.serialize(requestJudgeNominasi, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> postKompetisiIdNomination({ 
    required String komId,
    RequestAddNominasi? requestAddNominasi,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RequestAddNominasi);
      _bodyData = requestAddNominasi == null ? null : _serializers.serialize(requestAddNominasi, specifiedType: _type);
  ...
  Future<Response<RespondGlobal>> postKompetisiNominationId({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        if (participantId != null) r'participant_id': encodeFormParameter(_serializers, participantId, const FullType(String)),
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> postKompetisiNominationsIdParticipant({ 
    required String komId,
    required String nomId,
    RequestKompetisiNominasiPartisipant? requestKompetisiNominasiPartisipant,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> putKompetisiIdJudgement({ 
    required String komId,
    required String nomId,
    RequestJudgeNominasi? requestJudgeNominasi,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> putKompetisiIdNomination({ 
    required String komId,
    RequestEditNominasi? requestEditNominasi,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RequestEditNominasi);
      _bodyData = requestEditNominasi == null ? null : _serializers.serialize(requestEditNominasi, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [RespondGlobal] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RespondGlobal>> putKompetisiNominationId({ 
    required String komId,
