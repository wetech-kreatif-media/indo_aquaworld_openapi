...
class ForumApi {
  ...
  Future<Response<RespondComments>> getComments({ 
    ...
    RespondComments? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondComments),
      ) as RespondComments;
    ...
    return Response<RespondComments>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondForumArticle>> getForumArticle({ 
    ...
    RespondForumArticle? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondForumArticle),
    ...
    return Response<RespondForumArticle>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondForumArticles>> getForumArticles({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (topics != null) r'topics': encodeQueryParameter(_serializers, topics, const FullType(String)),
    };
    ...
    RespondForumArticles? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondForumArticles),
    ...
    return Response<RespondForumArticles>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondForumTopics>> getForumTopics({ 
    ...
    RespondForumTopics? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondForumTopics),
    ...
    return Response<RespondForumTopics>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondForums>> getForums({ 
    ...
    RespondForums? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondForums),
      ) as RespondForums;
  ...
  Future<Response<RespondGlobal>> postComment({ 
    ...
    try {
      const _type = FullType(RequestComment);
  ...
  Future<Response<PostForum201Response>> postForum({ 
    ...
    try {
      const _type = FullType(RequestForum);
  ...
  Future<Response<RespondGlobal>> postForumArticle({ 
    ...
    final _path = r'/public/forum-article';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RequestForumArticle);
  ...
  Future<Response<RespondGlobal>> postForumTopic({ 
    ...
    try {
      const _type = FullType(RequestForumTopic);
