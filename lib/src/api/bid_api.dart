...
class BidApi {
  ...
  const BidApi(this._dio, this._serializers);
  ...
  Future<Response<RespondBidders>> getBidders({ 
    ...
    RespondBidders? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondBidders),
      ) as RespondBidders;
    ...
    return Response<RespondBidders>(
      data: _responseData,
  ...
  Future<Response<RespondLastBid>> getLastBid({ 
    ...
    RespondLastBid? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondLastBid),
      ) as RespondLastBid;
    ...
    return Response<RespondLastBid>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondGlobal>> postBid({ 
    ...
    try {
      const _type = FullType(RequestBid);
