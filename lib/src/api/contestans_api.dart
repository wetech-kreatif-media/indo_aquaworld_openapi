...
class ContestansApi {
  ...
  const ContestansApi(this._dio, this._serializers);
  ...
  Future<Response<RespondGlobal>> createContestant({ 
    ...
    final _path = r'/public/contestant';
    ...
    try {
      const _type = FullType(RequestContestant);
  ...
  Future<Response<RespondContestant>> getContestant({ 
    ...
    RespondContestant? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondContestant),
    ...
    return Response<RespondContestant>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RespondContestants>> getContestants({ 
    ...
    final _path = r'/public/contestants';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RespondContestants? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondContestants),
    ...
    return Response<RespondContestants>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
