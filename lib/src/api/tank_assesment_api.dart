...
class TankAssesmentApi {

  final Dio _dio;

  final Serializers _serializers;

  const TankAssesmentApi(this._dio, this._serializers);
  ...
  Future<Response<RespondTankAssesment>> getTankAssessment({ 
    ...
    RespondTankAssesment? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RespondTankAssesment),
    ...
    return Response<RespondTankAssesment>(
      data: _responseData,
  ...
  Future<Response<RespondGlobal>> postTankAssessment({ 
    ...
    try {
      const _type = FullType(RequestTankAssesment);
