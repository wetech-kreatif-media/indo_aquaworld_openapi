...
------------ | ------------- | ------------- | -------------
[*EventsApi*](doc/EventsApi.md) | [**addEventNominationContestant**](doc/EventsApi.md#addeventnominationcontestant) | **POST** /public/event/{eventId}/contestan-nomination/{nominasiId} | Add Event Nomination Contestant
...
[*EventsApi*](doc/EventsApi.md) | [**getEventNominationsContestants**](doc/EventsApi.md#geteventnominationscontestants) | **GET** /public/event/{eventId}/contestan-nomination/{nominasiId} | Get Event Nomination Contestants
