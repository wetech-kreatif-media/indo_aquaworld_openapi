...
// tests for RespondSellingAllDataContentInnerUser
void main() {
  final instance = RespondSellingAllDataContentInnerUserBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingAllDataContentInnerUser, () {
    // String id
    ...
    // RespondSellingAllDataContentInnerUserRole role
