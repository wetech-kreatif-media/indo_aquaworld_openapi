...
// tests for RespondSellingAllData
void main() {
  final instance = RespondSellingAllDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingAllData, () {
    // bool last
    ...
    // BuiltList<RespondSellingAllDataContentInner> content
