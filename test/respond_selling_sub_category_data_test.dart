...
// tests for RespondSellingSubCategoryData
void main() {
  final instance = RespondSellingSubCategoryDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingSubCategoryData, () {
    // bool last
    ...
    // BuiltList<RespondSellingCategoriesDataContentInnerSellingSubCategorysInner> content
