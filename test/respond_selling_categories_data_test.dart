...
// tests for RespondSellingCategoriesData
void main() {
  final instance = RespondSellingCategoriesDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingCategoriesData, () {
    // bool last
    ...
    // BuiltList<RespondSellingCategoriesDataContentInner> content
