...
// tests for RespondEventDataContestComponentsInnerJudge
void main() {
  final instance = RespondEventDataContestComponentsInnerJudgeBuilder();
  // TODO add properties to the builder and call build()

  group(RespondEventDataContestComponentsInnerJudge, () {
    // String id
