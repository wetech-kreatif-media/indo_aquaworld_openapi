...
// tests for RespondSellingUserData
void main() {
  final instance = RespondSellingUserDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingUserData, () {
    // bool last
    ...
    // BuiltList<RespondSellingUserDataContentInner> content
