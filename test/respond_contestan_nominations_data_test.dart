...
// tests for RespondContestanNominationsData
void main() {
  final instance = RespondContestanNominationsDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondContestanNominationsData, () {
    // bool last
    ...
    // BuiltList<RespondContestanNominationsDataContentInner> content
