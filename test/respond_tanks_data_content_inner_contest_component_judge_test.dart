...
// tests for RespondTanksDataContentInnerContestComponentJudge
void main() {
  final instance = RespondTanksDataContentInnerContestComponentJudgeBuilder();
  // TODO add properties to the builder and call build()

  group(RespondTanksDataContentInnerContestComponentJudge, () {
    // String id
