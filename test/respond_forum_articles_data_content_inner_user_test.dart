...
// tests for RespondForumArticlesDataContentInnerUser
void main() {
  final instance = RespondForumArticlesDataContentInnerUserBuilder();
  // TODO add properties to the builder and call build()

  group(RespondForumArticlesDataContentInnerUser, () {
    // String id
    ...
    // RespondForumArticlesDataContentInnerUserRole role
