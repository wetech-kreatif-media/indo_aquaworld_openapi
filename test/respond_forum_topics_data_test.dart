...
// tests for RespondForumTopicsData
void main() {
  final instance = RespondForumTopicsDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondForumTopicsData, () {
    // bool last
    ...
    // BuiltList<RespondForumTopicsDataContentInner> content
