...
// tests for RespondSellingUserDataContentInnerUser
void main() {
  final instance = RespondSellingUserDataContentInnerUserBuilder();
  // TODO add properties to the builder and call build()

  group(RespondSellingUserDataContentInnerUser, () {
    // String id
