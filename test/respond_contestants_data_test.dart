...
// tests for RespondContestantsData
void main() {
  final instance = RespondContestantsDataBuilder();
  // TODO add properties to the builder and call build()

  group(RespondContestantsData, () {
    // bool last
    ...
    // BuiltList<RespondContestantsDataContentInner> content
