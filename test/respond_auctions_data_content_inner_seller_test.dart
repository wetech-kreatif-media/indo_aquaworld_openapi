...
// tests for RespondAuctionsDataContentInnerSeller
void main() {
  final instance = RespondAuctionsDataContentInnerSellerBuilder();
  // TODO add properties to the builder and call build()

  group(RespondAuctionsDataContentInnerSeller, () {
    // String id
    ...
    // RespondUsersDataContentInnerRole role
